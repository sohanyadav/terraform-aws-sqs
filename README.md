...
```hcl
module "sqs" {
  source      = "git::https://github.com/sohanyadav/terraform-aws-sqs?ref=v1.0.0"
...
data "aws_iam_policy_document" "document" {
  ...
  statement {
    ...
    resources = [
      format("arn:aws:sqs:eu-west-1:%s:test-sohanyadav-sqs", data.aws_caller_identity.current.account_id)
    ]
  }
}
```
...
## Examples
For detailed examples on how to use this module, please refer to the [examples](https://github.com/sohanyadav/terraform-aws-sqs/tree/master/_example) directory within this repository.

## License
This Terraform module is provided under the **MIT** License. Please see the [LICENSE](https://github.com/sohanyadav/terraform-aws-sqs/blob/master/LICENSE) file for more details.
...
| <a name="input_repository"></a> [repository](#input\_repository) | Terraform current module repo | `string` | `"https://github.com/sohanyadav/terraform-aws-sqs"` | no |
